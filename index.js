...
$(document).ready(()=>{
    ...
    $('#li1').click(()=>{
        $('.txt-hide').show(0);
        $('#div2,.about, .work,.contact-m').hide(0);
        })
    ...
    // });
        ...
        // text
            ...
            $("#li1").hover(
                ()=>{
                    $('#a1').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
                },
                ()=>{
                    $('#a1').css({ "font-size" : "18px" , "color":"white" , "font-style" : "normal" })
        ...
        // text
            ...
            $("#li2").hover(
                ()=>{
                    $('#a2').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
                },
                ()=>{
                    $('#a2').css({ "font-size" : "18px" , "color":"white" , "font-style" : "normal" })
        ...
        // text
            ...
            $("#li3").hover(
                ()=>{
                    $('#a3').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
                },
                ()=>{
                    $('#a3').css({ "font-size" : "18px" , "color":"white" , "font-style" : "normal" })
        ...
        // text
            ...
            $("#li4").hover(
                ()=>{
                    $('#a4').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
                },
                ()=>{
                    $('#a4').css({ "font-size" : "18px" , "color":"white" , "font-style" : "normal" })
    ...
    // text
        ...
        $("#a-li1").hover(
            ()=>{
                $('#a-li1').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li1').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    $("#a-li1").hover(
        ()=>{
    $(" #a-li2 , #a-li3 , #a-li4 , #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideUp(1000)
        },
        ()=>{
            $(" #a-li2 , #a-li3 , #a-li4 , #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideDown(1000)
        })
    ...
    // text
        ...
        $("#a-li2").hover(
            ()=>{
                $('#a-li2').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li2').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    $("#a-li2").hover(
        ()=>{
    $(" #a-li3 , #a-li4 , #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideUp(1000)
        },
        ()=>{
            $(" #a-li3 , #a-li4 , #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideDown(1000)
        })
    ...
    // text
        ...
        $("#a-li3").hover(
            ()=>{
                $('#a-li3').css({ "font-size" : "29px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li3').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    $("#a-li3").hover(
        ()=>{
    $(" #a-li4 , #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideUp(1000)
        },
        ()=>{
            $(" #a-li4 , #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideDown(1000)
        })
    ...
    // text
        ...
        $("#a-li4").hover(
            ()=>{
                $('#a-li4').css({ "font-size" : "28px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li4').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    $("#a-li4").hover(
        ()=>{
    $(" #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideUp(1000)
        },
        ()=>{
            $(" #a-li5 , #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideDown(1000)
        })
    ...
    // text
        ...
        $("#a-li5").hover(
            ()=>{
                $('#a-li5').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li5').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    $(" #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideUp(1000)
        ...
        ()=>{
            $(" #a-li6 , #a-li7 , #a-li8 , #a-li9 , #a-li10 , #a-li11").slideDown(1000)
        })
    ...
    // text
        ...
        $("#a-li6").hover(
            ()=>{
                $('#a-li6').css({ "font-size" : "27px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li6').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    // text
        ...
        $("#a-li7").hover(
            ()=>{
                $('#a-li7').css({ "font-size" : "26px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li7').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    // text
        ...
        $("#a-li8").hover(
            ()=>{
                $('#a-li8').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li8').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    // text
        ...
        $("#a-li9").hover(
            ()=>{
                $('#a-li9').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li9').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    // text
        ...
        $("#a-li10").hover(
            ()=>{
                $('#a-li10').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li10').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
    ...
    // text
        ...
        $("#a-li11").hover(
            ()=>{
                $('#a-li11').css({ "font-size" : "40px" , "color":"black" , "font-style" : "italic" })
            },
            ()=>{
                $('#a-li11').css({ "font-size" : "24px" , "color":"white" , "font-style" : "normal" })
